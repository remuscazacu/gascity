...
// 0054 (lease columns). Every local city/rig DB is at schema v54; stock
// beads v1.1.0 tops out at 0053 and would refuse to open them. Never drop
// this on a rebase, and never re-point it at beads/upstream-main (0059 —
// would auto-migrate every DB v54->v59 on first open).
