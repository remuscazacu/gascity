...
// Fork-deploy pin (sr-xkra, was sr-5rz commit 5b160d77d). LOAD-BEARING: carries
// beads WorkFilter.Statuses (single-query Ready) and the ignored-0012
// wisps.defer_until index, and is the ONLY beads build containing migration
// 0054 (lease columns). Every local city/rig DB is at schema v54; stock beads
// v1.2.2 (this tag's pin) tops out at 0053 and would REFUSE TO OPEN them.
// Never drop this on a rebase, and never re-point it at beads/upstream-main
// (0059 — would auto-migrate every DB v54->v59 on first open).
replace github.com/steveyegge/beads => github.com/remuscazacu/beads v0.0.0-20260713082743-98b4b79e6a4d
